"""
Unit tests for CustomerUser model.
Tests all model fields, methods, and business logic.
"""
...
class CustomerUserModelTest(TestCase):
    ...
    def test_soft_delete_method(self):
        ...
        self.assertIsNotNone(self.customer_user.display_name)
        self.assertIsNotNone(self.customer_user.phone_number)
...
class ConsentRecordModelTest(TestCase):
    ...
    def test_consent_str_representation(self):
        ...
        expected = "LOCATION: True for testuser@example.com"
